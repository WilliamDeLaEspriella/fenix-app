              ...
              child: SingleChildScrollView(
                child: Column(
                  children: <Widget>[
                    ...
                    const SizedBox(height: 20.0),
                    GestureDetector(
                      child: Text("Olvido su Contraseña".toUpperCase(), style: TextStyle(
                        color: Theme.of(context).primaryColor,
                    ...
                    Row(
                      children: <Widget>[
                        ...
                        const SizedBox(width: 10.0),
                        Text("No es un miembro?",style: smallText,),
                        const SizedBox(width: 10.0),
                        Expanded(child: Divider(color: Colors.grey.shade600,)),
                      ],
                    ),
                    const SizedBox(height: 20.0),
                    GestureDetector(
                      child: Text("Crear una Cuenta".toUpperCase(), style: TextStyle(
                        color: Theme.of(context).primaryColor,
                        fontWeight: FontWeight.w600
                      ),),
                      onTap: (){
